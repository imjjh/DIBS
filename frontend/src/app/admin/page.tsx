        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">관리자 전용 판매자 입점 신청 관리 페이지입니다.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-slate-200 p-6 rounded-[2rem] shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Notice</p>
                        <p className="text-2xl font-black text-slate-900">승인 건 검토</p>
                    </div>
                </div>
                <div className="bg-white border border-slate-200 p-6 rounded-[2rem] shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Hint</p>
                        <p className="text-sm font-bold text-slate-400">사업자 번호 확인 필수</p>
                    </div>
                </div>
            </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50 text-slate-400 border-b border-slate-100">
                                ...
                                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">상호명</th>
                                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">사업자 번호</th>
                                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">상태</th>
                                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">액션</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                            {loading ? (
                                <tr>
                                    <td colSpan={6} className="px-8 py-20 text-center text-slate-300 font-bold">로딩 중...</td>
                                </tr>
                            ) : applications.length === 0 ? (
                                <tr>
                                    <td colSpan={6} className="px-8 py-20 text-center text-slate-300 font-bold tracking-tight">신청 내역이 없습니다.</td>
                                </tr>
                            ) : (
            ...
            {rejectingId && (
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
                    <div className="bg-white border border-slate-200 p-10 rounded-[2.5rem] w-full max-w-lg shadow-2xl space-y-8">
                        <div>
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="flex-1 py-4 border border-slate-200 font-black rounded-2xl hover:bg-slate-50 transition-all text-slate-600"
                            >
                                취소
                            </button>
                            <button
                                onClick={() => handleReject(rejectingId)}
                                className="flex-1 py-4 bg-red-500 text-white font-black rounded-2xl hover:bg-red-600 transition-all shadow-lg shadow-red-500/20"
                            >
                                거절 확정
                            </button>
                        </div>
