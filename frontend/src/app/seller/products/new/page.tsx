                    ...
                    <div className="bg-[#0f0f12] border border-white/5 rounded-[2.5rem] p-8 space-y-6 sticky top-8">
                        ...
                        <div className="p-4 bg-white/5 rounded-2xl border border-white/5 space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[10px] font-bold text-white/60 lowercase">깔끔한 배경의 사진을 권장합니다</p>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-3 h-3 text-emerald-500" />
                                <p className="text-[10px] font-bold text-white/60 lowercase">다양한 각도의 사진을 추가하면 좋습니다</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-[#0f0f12] border border-white/5 rounded-[3rem] p-10 space-y-10 shadow-2xl">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] ml-1">상품명</label>
                                    <input
                                        type="text"
                                        required
                        ...
                        <div className="space-y-8 pt-10 border-t border-white/5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] ml-1">재고 수량</label>
                                    <div className="relative">
