...
public class SellerProductController {
    ...
    public ApiResponse<PagedResponse<ProductSimpleResponseDto>> myProduct(
            @AuthenticationPrincipal CustomUserDetails userDetails,
            @ModelAttribute @Valid ProductSearchRequestDto requestDto) {
        return ApiResponse.success(sellerProductService.searchBySeller(userDetails, requestDto));
    }
}
